...
\hbox{\mbox{%
        \hspace{-20pt}%
        \fbox{\scalebox{.8}{\includegraphics{\LOGO}}}%
        \hspace{4pt}
        }
      ...
      \vtop{% %%%%%%%%%%%%%%%%%%
        ...
        \vspace{80pt}
        \begin{flushleft}
          \Huge \bfseries Κρυπτογραφία :  \par
        \end{flushleft}
        \begin{flushleft}
        ...
        \end{flushleft}
         \vspace{250pt}
        \begin{flushleft}
          \large  \YPOTITLOS \\ Τμήμα Μαθηματικών Ε.Κ.Π.Α. \\ Διδάσκων : Ευάγγελος Ράπτης \par
        \end{flushleft}
        \vfil
        }}
  \end{titlepage}%
...
%Individual lecture header
\newcommand{\doheader}{
\fancyhead[LO,RE]{\textsc{\THEMA}}
\fancyhead[LE,RO]{\textsc{\ONOMA}}
}
% #1 Handout Number
% #2 Date/Semester
